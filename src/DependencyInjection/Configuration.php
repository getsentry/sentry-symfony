                    ...
                    ->children()
                        ...
                        ->arrayNode('console')
                            ...
                            ->children()
                                ...
                                ->end()
                                ->arrayNode('trace_propagation')
                                    ->canBeEnabled()
                                    ->children()
                                        ->scalarNode('inputoption_name')
                                            ->info('The name of the InputOption to add for trace propagation from console commands.')
                                            ->defaultValue('sentry-trace')
                                        ->end()
                                    ->end()
                                ->end()
                            ->end()
